...
public sealed class RolloverQueryBuilderRequestBuilder
{
    ...
    private readonly HashSet<Guid> _awardingOrganisationIds = [];
    ...
    public RolloverQueryBuilderRequestBuilder WithAwardingOrganisations(IEnumerable<Guid> awardingOrganisationIds)
    {
        AddValues(_awardingOrganisationIds, awardingOrganisationIds.Where(id => id != Guid.Empty));
        return this;
    }
