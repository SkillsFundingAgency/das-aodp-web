...
{
    public class WhenHandlingMoveFormDownCommand
    {
        private readonly Fixture _fixture = new();
        private readonly Mock<IApiClient> _apiClient = new();
        private readonly MoveFormDownCommandHandler _handler;

        public WhenHandlingMoveFormDownCommand()
        {
        ...
        public async Task Then_The_CommandResult_Is_Returned_As_Expected()
        {
            ...
            _apiClient
                .Setup(a => a.Put(It.IsAny<MoveFormDownApiRequest>()));
            ...
            // Assert
            _apiClient
                .Verify(a => a.Put(It.Is<MoveFormDownApiRequest>(r => r.FormVersionId == request.FormId)));
