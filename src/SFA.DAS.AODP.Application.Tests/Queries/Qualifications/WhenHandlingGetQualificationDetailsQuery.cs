...
{
    public class WhenHandlingGetQualificaitonDetailsQuery
    {
        private readonly IFixture _fixture;
        private readonly Mock<IApiClient> _apiClientMock;
        private readonly GetQualificationDetailsQueryHandler _handler;

        public WhenHandlingGetQualificaitonDetailsQuery()
        {
        ...
        public async Task Then_The_CommandResult_Is_Returned_As_Expected()
        {
            ...
            var request = _fixture.Create<GetQualificationDetailsQuery>();
            _apiClientMock
                .Setup(a => a.Get<GetQualificationDetailsQueryResponse>(It.IsAny<GetQualificationDetailsApiRequest>()))
            ...
            // Assert
            _apiClientMock
                .Verify(a => a.Get<GetQualificationDetailsQueryResponse>(It.IsAny<GetQualificationDetailsApiRequest>()));
