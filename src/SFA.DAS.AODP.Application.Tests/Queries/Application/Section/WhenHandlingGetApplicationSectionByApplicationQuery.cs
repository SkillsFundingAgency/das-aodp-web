...
{
    public class WhenHandlingGetApplicationSectionByApplicationQuery
    {
        ...
        public WhenHandlingGetApplicationSectionByApplicationQuery()
        {
        ...
        public async Task Then_The_Api_Is_Called_With_The_Request_And_ApplicationFormData_By_Id_Is_Returned()
        {
            ...
            Assert.NotNull(result.Value.Pages.Count);
